    ...
    const projects = [
        {
            ...
            name: "WeatherTrack",
            description: "An intuitive platform for monitoring real-time weather conditions, viewing future forecasts, and analyzing detailed statistics of weather searches.",
            tecnologies: [
                { name: "Vue.js" },
                { name: "Bootstrap" },
                { name: "API" },
